...
Additionally, there is a limit to the number of nodes that a single instance of Unified Manager can monitor before you install a second instance of Unified Manager. For more information, see link:https://www.netapp.com/pdf.html?item=/media/13504-tr4621.pdf[Unified Manager Best Practices Guide^]
